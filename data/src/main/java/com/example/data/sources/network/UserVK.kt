                ...
                object : VKApiCallback<GroupsGetMembersFieldsResponse> {
                    override fun success(result: GroupsGetMembersFieldsResponse) {
                        if(result.items.isEmpty()) {
                            it.resume(UserModel.ResponsParams.Failed(0, "Больше данных нет"))
                        } else {
                            ...
                            itms.forEach {
                                ...
                                val tme: Int = (unixTime - lastSeen) / 60
                            ...
                            it.resume(UserModel.ResponsParams.Success(myItms, 0))
                        }
                    }
